...
public class DelsTest {

	// 删除税收类型
	@Test
	public void delsTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.delsUrl);
		System.out.println(TestConfig.delsUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("taxId", ListsTest.stringId);
