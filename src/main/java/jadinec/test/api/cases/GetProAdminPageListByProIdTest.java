...
public class GetProAdminPageListByProIdTest {

	public static String stringId = null;
	// 分页查询项目部管理员列表
	@Test
	public void getProAdminPageListByProIdTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("contactNumber").toString().contains("18600000017")) {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getProAdminPageListByProIdUrl);
		System.out.println(TestConfig.getProAdminPageListByProIdUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();
		JSONObject param3 = new JSONObject();
		
		param3.put("proId", "1003");
