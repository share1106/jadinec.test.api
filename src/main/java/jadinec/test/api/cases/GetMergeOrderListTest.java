...
public class GetMergeOrderListTest {

	// 可并单列表
	@Test
	public void getMergeOrderListTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getMergeOrderListUrl);
		System.out.println(TestConfig.getMergeOrderListUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();
		JSONObject param3 = new JSONObject();
		
		param3.put("keyWord", "土门");
