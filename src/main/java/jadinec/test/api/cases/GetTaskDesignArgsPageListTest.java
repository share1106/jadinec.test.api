...
public class GetTaskDesignArgsPageListTest {

	public static String stringId = null;
	// 分页列表
	@Test
	public void getTaskDesignArgsPageListTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("ledgerCode").toString().contains("403-1-a")) {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getTaskDesignArgsPageListUrl);
		System.out.println(TestConfig.getTaskDesignArgsPageListUrl);
		...
		param2.put("ledgerCode", "");// 清单编号
		param2.put("subunitEngineeringName", "");
		param2.put("engineeringName", "");
		param2.put("ledgerName", "");
		param2.put("unitCode", unitCode);
		param2.put("designModel", "");
		param2.put("processCode", "");
		param2.put("remarks", "");
