...
public class ExportProUserTest {
	
	// 导出项目部人员列表
	@Test(enabled=false)
	public void exportProUserTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.exportProUserUrl);
		System.out.println(TestConfig.exportProUserUrl);
