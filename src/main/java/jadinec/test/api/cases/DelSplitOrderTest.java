...
public class DelSplitOrderTest {

	// 删除分单
	@Test
	public void delSplitOrderTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.delSplitOrderUrl);
		System.out.println(TestConfig.delSplitOrderUrl);
