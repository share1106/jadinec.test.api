...
public class ObtainTeamListTest {

	// 获取承包所有施工队
	@Test
	public void obtainTeamListTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.obtainTeamListUrl);
		System.out.println(TestConfig.obtainTeamListUrl);
