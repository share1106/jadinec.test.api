...
public class GetEntireOrgProTreeByProIdTest {

	// 根据proId获取整个项目部树
	@Test
	public void getEntireOrgProTreeByProIdTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getEntireOrgProTreeByProIdUrl);
		System.out.println(TestConfig.getEntireOrgProTreeByProIdUrl);
