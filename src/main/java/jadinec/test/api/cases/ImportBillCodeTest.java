...
public class ImportBillCodeTest {
	...
	@Test
	public void importBillCodeTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		...
		filePath = "src/main/resources/清单编码管理表.xlsx";
		...
		form.add("filename", "清单编码管理表.xlsx");
		form.add("Content-Type", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");

		HttpEntity<MultiValueMap<String, Object>> files = new HttpEntity<>(form, headers);
		ResponseEntity<String> responseEntity = restTemplate.postForEntity(TestConfig.importBillCodeUrl, files,
				String.class, "UTF-8");
		System.out.println(TestConfig.importBillCodeUrl);
		String result;
