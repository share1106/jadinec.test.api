...
public class GetProsByOrgIdTest {

	// 根据机构id查询项目部列表
	@Test
	public void getProsByOrgIdTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getProsByOrgIdUrl);
		System.out.println(TestConfig.getProsByOrgIdUrl);
