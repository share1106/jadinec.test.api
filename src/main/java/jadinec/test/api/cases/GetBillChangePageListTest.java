...
public class GetBillChangePageListTest {

	public static String stringId;

	// 获取列表
	@Test
	public void getBillChangePageListTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("ledgerCode").toString().contains("share006")) {
				stringId = jsonObj.get("billId").toString();
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getBillChangePageListUrl);
		System.out.println(TestConfig.getBillChangePageListUrl);
