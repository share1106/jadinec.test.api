...
public class GetOrgListByPageTest {

	// 分页获取组织机构列表
	@Test
	public void getOrgListByPageTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getOrgListByPageUrl);
		System.out.println(TestConfig.getOrgListByPageUrl);
