...
public class FindOrgInfoByUserIdTest {

	// 根据用户id获取组织机构
	@Test
	public void findOrgInfoByUserIdTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.findOrgInfoByUserIdUrl);
		System.out.println(TestConfig.findOrgInfoByUserIdUrl);
