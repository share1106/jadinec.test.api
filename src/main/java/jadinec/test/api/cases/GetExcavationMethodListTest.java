...
public class GetExcavationMethodListTest {

	public static String stringId = null;

	// 隧道开挖方法管理列表
	@Test
	public void getExcavationMethodListTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("excavationMethodName").toString().contains("开挖方法名称888")) {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getExcavationMethodListUrl);
		System.out.println(TestConfig.getExcavationMethodListUrl);
