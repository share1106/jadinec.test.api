...
public class ImportCrossSectionInfoTest {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		...
		filePath = "src/main/resources/工程横断面信息管理表.xlsx";
		...
		form.add("filename", "工程横断面信息管理表.xlsx");
		form.add("Content-Type", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
				
		HttpEntity<MultiValueMap<String,Object>> files = new HttpEntity<>(form,headers);
		ResponseEntity<String> responseEntity = restTemplate.postForEntity(TestConfig.importCrossSectionInfoUrl, files,String.class,"UTF-8");
