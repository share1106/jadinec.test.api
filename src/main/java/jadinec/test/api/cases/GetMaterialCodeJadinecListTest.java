...
public class GetMaterialCodeJadinecListTest {

	public static String stringId = null;
	// 查询平台物料列表代码
		@Test
		public void getMaterialCodeJadinecListTest() throws IOException {
			...
			for (int k = 0; k < ja.size(); k++) {
				...
				if (jsonObj.get("materialCode").toString().contains("WL666")) {
		...
		private JSONArray getJsonResult() throws ClientProtocolException, IOException {
			HttpPost post = new HttpPost(TestConfig.getMaterialCodeJadinecListUrl);
			System.out.println(TestConfig.getMaterialCodeJadinecListUrl);
