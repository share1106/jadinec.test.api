...
public class GetAppResListTest {

	// 根据用户id获取APP的资源菜单
	@Test(enabled=false)
	public void getAppResListTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getAppResListUrl);
		System.out.println(TestConfig.getAppResListUrl);
