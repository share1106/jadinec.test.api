...
public class GetDrawLevelPageListTest {

	public static String stringId = null;

	// 运营平台-绘制层级-分页列表
	@Test
	public void getDrawLevelPageListTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("name").toString().contains("测试层级666")) {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getDrawLevelPageListUrl);
		System.out.println(TestConfig.getDrawLevelPageListUrl);
