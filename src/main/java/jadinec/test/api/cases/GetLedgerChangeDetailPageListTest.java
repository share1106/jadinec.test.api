...
public class GetLedgerChangeDetailPageListTest {

	public static String stringId= null;

	// 变更明细-分页列表
	@Test
	public void getLedgerChangeDetailPageListTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("engineeringCode").toString().contains("JDGF-1-001-001-001-001-041-000")) {
				stringId = jsonObj.get("ledgerId").toString();
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getLedgerChangeDetailPageListUrl);
		System.out.println(TestConfig.getLedgerChangeDetailPageListUrl);
