...
public class AddOrUpdateBillCodeTest {

	// 添加修改清单编码
	@Test
	public void addOrUpdateBillCodeTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.addOrUpdateBillCodeUrl);
		System.out.println(TestConfig.addOrUpdateBillCodeUrl);
