...
public class GetProRoleInfoListByPageTest {

	// 分页获取项目部角色列表
	@Test
	public void getProRoleInfoListByPageTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getProRoleInfoListByPageUrl);
		System.out.println(TestConfig.getProRoleInfoListByPageUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();
		JSONObject param3 = new JSONObject();

		param3.put("proId", "7");
		param3.put("roleName", "工人");
