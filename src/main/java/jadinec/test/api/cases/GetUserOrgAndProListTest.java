...
public class GetUserOrgAndProListTest {

	// 查询用户的机构列表和项目列表
	@Test
	public void getUserOrgAndProListTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getUserOrgAndProListUrl);
		System.out.println(TestConfig.getUserOrgAndProListUrl);
