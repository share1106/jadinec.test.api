...
public class UpdateOrgJobTest {

	// 修改组织机构岗位
	@Test
	public void updateOrgJobTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.updateOrgJobUrl);
		System.out.println(TestConfig.updateOrgJobUrl);
		...
		param2.put("jobId", GetOrgJobInfoListByPageTest.stringId);
		param2.put("jobName", "测试新增岗位2");
		param2.put("jobCode", "ROLE_TECHNICIAN");
		param2.put("jobDesc", "test1");
