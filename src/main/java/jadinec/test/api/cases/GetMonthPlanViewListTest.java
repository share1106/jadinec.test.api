...
public class GetMonthPlanViewListTest {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getMonthPlanViewListUrl);
		System.out.println(TestConfig.getMonthPlanViewListUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("pageSize", 10);// 每页条数
		param2.put("pageNum", 1);// 页数
		param2.put("monthPlanId", 64);//月计划id
		param2.put("data", null);
