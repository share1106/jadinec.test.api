...
public class AddOrgDeptInfoTest {

	// 新增组织机构部门
	@Test
	public void addOrgDeptInfoTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.addOrgDeptInfoUrl);
		System.out.println(TestConfig.addOrgDeptInfoUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();
		
		param2.put("orgDeptName", "测试添加部门");
