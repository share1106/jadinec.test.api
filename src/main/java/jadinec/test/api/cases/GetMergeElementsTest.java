...
public class GetMergeElementsTest {

	// 查询并单信息
	@Test
	public void getMergeElementsTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getMergeElementsUrl);
		System.out.println(TestConfig.getMergeElementsUrl);
