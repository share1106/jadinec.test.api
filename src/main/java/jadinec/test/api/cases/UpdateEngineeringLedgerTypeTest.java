...
public class UpdateEngineeringLedgerTypeTest {

	// 编辑
	@Test
	public void updateEngineeringLedgerTypeTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.updateEngineeringLedgerTypeUrl);
		System.out.println(TestConfig.updateEngineeringLedgerTypeUrl);
