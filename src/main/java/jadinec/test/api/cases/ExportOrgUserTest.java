...
public class ExportOrgUserTest {

	// 导出机构人员列表
	@Test(enabled=false)
	public void exportOrgUserTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.exportOrgUserUrl);
		System.out.println(TestConfig.exportOrgUserUrl);
