...
public class AddOrgProInfoTest {

	// 新增项目部
		@Test
		public void addOrgProInfoTest() throws IOException {
		...
		private JSONArray getJsonResult() throws ClientProtocolException, IOException {
			HttpPost post = new HttpPost(TestConfig.addOrgProInfoUrl);
			System.out.println(TestConfig.addOrgProInfoUrl);
