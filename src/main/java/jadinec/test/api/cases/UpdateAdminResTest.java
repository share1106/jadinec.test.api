...
public class UpdateAdminResTest {

	// 修改管理员权限
	@Test
	public void updateAdminResTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.updateAdminResUrl);
		System.out.println(TestConfig.updateAdminResUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();
		JSONObject param3 = new JSONObject();
		
		param3.put("resId", "213038074769084416");//资源id
		param3.put("resId", "213037091339014144");
