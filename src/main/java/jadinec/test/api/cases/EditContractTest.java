...
public class EditContractTest {

	// 编辑合同信息
	@Test
	public void editContractTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.editContractUrl);
		System.out.println(TestConfig.editContractUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("id", "176");
		param2.put("contCode", "HT-00001");
		param2.put("contAmount", "500");
		param2.put("contName", "测试合同12");
