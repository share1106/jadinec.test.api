...
public class GetEntireOrgTreeByOrgIdTest {

	// 修改运营平台组织机构基本信息
	@Test
	public void getEntireOrgTreeByOrgIdTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getEntireOrgTreeByOrgIdUrl);
		System.out.println(TestConfig.getEntireOrgTreeByOrgIdUrl);
