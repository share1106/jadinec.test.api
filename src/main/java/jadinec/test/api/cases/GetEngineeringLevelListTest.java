...
public class GetEngineeringLevelListTest {

	public static String stringId;

	// 分页查询工程级别列表
	@Test
	public void getEngineeringLevelListTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getEngineeringLevelListUrl);
		System.out.println(TestConfig.getEngineeringLevelListUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("keyWords", "单位工程");// 查询条件
