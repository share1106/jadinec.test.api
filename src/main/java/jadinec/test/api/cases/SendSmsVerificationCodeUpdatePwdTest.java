...
public class SendSmsVerificationCodeUpdatePwdTest {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.sendSmsVerificationCodeUpdatePwdUrl);
		System.out.println(TestConfig.sendSmsVerificationCodeUpdatePwdUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("phoneNum", "17723890279");
