...
public class GetOrgJobDicListTest {

	// 查询获取岗位编码字典列表数据
	@Test
	public void getOrgJobDicListTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getOrgJobDicListUrl);
		System.out.println(TestConfig.getOrgJobDicListUrl);
