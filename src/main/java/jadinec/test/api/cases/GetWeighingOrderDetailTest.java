...
public class GetWeighingOrderDetailTest {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getWeighingOrderDetailUrl);
		System.out.println(TestConfig.getWeighingOrderDetailUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("proCode", 8);// 项目编号
		param2.put("scaleNum", "FLD202007148658");// 称重单据
