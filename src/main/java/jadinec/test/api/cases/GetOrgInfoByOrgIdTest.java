...
public class GetOrgInfoByOrgIdTest {

	// 根据orgId获取组织机构
	@Test
	public void getOrgInfoByOrgIdTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getOrgInfoByOrgIdUrl);
		System.out.println(TestConfig.getOrgInfoByOrgIdUrl);
