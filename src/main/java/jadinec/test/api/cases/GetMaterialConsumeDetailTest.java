...
public class GetMaterialConsumeDetailTest {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getMaterialConsumeDetailUrl);
		System.out.println(TestConfig.getMaterialConsumeDetailUrl);
		...
		param2.put("materialCode", "WL-01-01-01-0001-200-04e");//物料编码
