...
public class GetUnitEngineeringAndDeptTest {

	// 获取分包商统计三级页面数据
	@Test
	public void getUnitEngineeringAndDeptTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getUnitEngineeringAndDeptUrl);
		System.out.println(TestConfig.getUnitEngineeringAndDeptUrl);
