...
public class GetMaterialCategoryPageListTest {

	public static String stringId = null;
	// 分页列表
	@Test
	public void getMaterialCategoryPageListTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("categoryCode").toString().contains("3")) {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getMaterialCategoryPageListUrl);
		System.out.println(TestConfig.getMaterialCategoryPageListUrl);
