...
public class AddTaskDesignArgsTest {

	// 增加
	@Test
	public void addTaskDesignArgsTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.addTaskDesignArgsUrl);
		System.out.println(TestConfig.addTaskDesignArgsUrl);
