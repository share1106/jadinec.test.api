...
public class DelOrgInfoByOrgIdTest {

	// 根据orgId逻辑删除组织机构
	@Test
	public void delOrgInfoByOrgIdTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.delOrgInfoByOrgIdUrl);
		System.out.println(TestConfig.delOrgInfoByOrgIdUrl);
