...
public class GetOrgRoleInfoByRoleIdTest {

	// 根据角色id获取角色信息
	@Test
	public void getOrgRoleInfoByRoleIdTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getOrgRoleInfoByRoleIdUrl);
		System.out.println(TestConfig.getOrgRoleInfoByRoleIdUrl);
