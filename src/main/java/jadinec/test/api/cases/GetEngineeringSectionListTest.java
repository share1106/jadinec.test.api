...
public class GetEngineeringSectionListTest {

	public static String stringId = null;

	// 章节管理分页列表
	@Test
	public void getEngineeringSectionListTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("engineeringSectionName").toString().contains("测试章节")) {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getEngineeringSectionListUrl);
		System.out.println(TestConfig.getEngineeringSectionListUrl);
