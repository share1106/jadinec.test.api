...
public class GetPlanManageTaskTest {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getPlanManageTaskUrl);
		System.out.println(TestConfig.getPlanManageTaskUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("processCode", "GX0101");
		param2.put("state", "1");
		param2.put("date", "2019-05");
