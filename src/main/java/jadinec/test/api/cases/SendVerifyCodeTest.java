...
public class SendVerifyCodeTest {
	...
	// 发送短信验证码
	@Test
	public void sendVerifyCodeTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.sendVerifyCodeUrl);
		System.out.println(TestConfig.sendVerifyCodeUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("contactNumber", "18611599121");// 用户id
