...
public class GetFileHistoryListTest {

	public static String stringId;

	// 查看文件导入导出记录
	@Test
	public void getFileHistoryListTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getFileHistoryListUrl);
		System.out.println(TestConfig.getFileHistoryListUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("keyWords", "工程细目种类模块");// 查询条件
