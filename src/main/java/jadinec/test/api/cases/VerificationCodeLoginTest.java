...
public class VerificationCodeLoginTest {
	...
	public void beforeTest() {
		...
		TestConfig.importSubsidiaryFacilitiesTypeInfoUrl = ConfigFile.getUrl(InterfaceName.ImportSubsidiaryFacilitiesTypeInfo);
		TestConfig.getSubsidiaryFacilitiesTypeInfoListUrl = ConfigFile.getUrl(InterfaceName.GetSubsidiaryFacilitiesTypeInfoList);
		TestConfig.getNewEngineeringItemVerticalPointUrl = ConfigFile.getUrl(InterfaceName.GetNewEngineeringItemVerticalPoint);
		TestConfig.getNewEngineeringItemHorizontalInfoUrl = ConfigFile.getUrl(InterfaceName.GetNewEngineeringItemHorizontalInfo);
		TestConfig.getNewEngineeringPlaneUrl = ConfigFile.getUrl(InterfaceName.GetNewEngineeringPlane);
		TestConfig.getEngineeringCenterPositionListUrl = ConfigFile.getUrl(InterfaceName.GetEngineeringCenterPositionList);
		TestConfig.getEngCenterPositionListUrl = ConfigFile.getUrl(InterfaceName.GetEngCenterPositionList);
		TestConfig.getNewEngineeringItemHorizontalUrl = ConfigFile.getUrl(InterfaceName.GetNewEngineeringItemHorizontal);
		TestConfig.getFinishStateEngCodeListUrl = ConfigFile.getUrl(InterfaceName.GetFinishStateEngCodeList);
		TestConfig.getBillCodeListUrl = ConfigFile.getUrl(InterfaceName.GetBillCodeList);
		TestConfig.addOrUpdateBillCodeUrl = ConfigFile.getUrl(InterfaceName.AddOrUpdateBillCode);
		TestConfig.delBillCodeByIdsUrl = ConfigFile.getUrl(InterfaceName.DelBillCodeByIds);
		TestConfig.exportBillCodeUrl = ConfigFile.getUrl(InterfaceName.ExportBillCode);
		TestConfig.importBillCodeUrl = ConfigFile.getUrl(InterfaceName.ImportBillCode);
		TestConfig.getSearchBillCodeListUrl = ConfigFile.getUrl(InterfaceName.GetSearchBillCodeList);
		TestConfig.getBillCodecheckUrl = ConfigFile.getUrl(InterfaceName.GetBillCodecheck);
		TestConfig.getUnitPageListUrl = ConfigFile.getUrl(InterfaceName.GetUnitPageList);
		TestConfig.addUnitUrl = ConfigFile.getUrl(InterfaceName.AddUnit);
		TestConfig.updateUnitUrl = ConfigFile.getUrl(InterfaceName.UpdateUnit);
		TestConfig.delUnitUrl = ConfigFile.getUrl(InterfaceName.DelUnit);
		TestConfig.exportUnitUrl = ConfigFile.getUrl(InterfaceName.ExportUnit);
		TestConfig.importUnitUrl = ConfigFile.getUrl(InterfaceName.ImportUnit);
		TestConfig.getUnitListUrl = ConfigFile.getUrl(InterfaceName.GetUnitList);
		TestConfig.getQuantitiesBillPageListUrl = ConfigFile.getUrl(InterfaceName.GetQuantitiesBillPageList);
		TestConfig.getEngineeringLedgerTypeListUrl = ConfigFile.getUrl(InterfaceName.GetEngineeringLedgerTypeList);
		TestConfig.addEngineeringLedgerTypeUrl = ConfigFile.getUrl(InterfaceName.AddEngineeringLedgerType);
		TestConfig.updateEngineeringLedgerTypeUrl = ConfigFile.getUrl(InterfaceName.UpdateEngineeringLedgerType);
		TestConfig.delEngineeringLedgerTypeUrl = ConfigFile.getUrl(InterfaceName.DelEngineeringLedgerType);
		TestConfig.exportEngineeringLedgerTypeUrl = ConfigFile.getUrl(InterfaceName.ExportEngineeringLedgerType);
		TestConfig.importEngineeringLedgerTypeUrl = ConfigFile.getUrl(InterfaceName.ImportEngineeringLedgerType);
		TestConfig.getSearchLedgerTypeUrl = ConfigFile.getUrl(InterfaceName.GetSearchLedgerType);
		TestConfig.addQuantitiesBillUrl = ConfigFile.getUrl(InterfaceName.AddQuantitiesBill);
		TestConfig.updateQuantitiesBillUrl = ConfigFile.getUrl(InterfaceName.UpdateQuantitiesBill);
		TestConfig.delQuantitiesBillUrl = ConfigFile.getUrl(InterfaceName.DelQuantitiesBill);
		TestConfig.getQuantitiesBillListUrl = ConfigFile.getUrl(InterfaceName.GetQuantitiesBillList);
		TestConfig.baseExportUrl = ConfigFile.getUrl(InterfaceName.BaseExport);
		TestConfig.getLedgerPageListUrl = ConfigFile.getUrl(InterfaceName.GetLedgerPageList);
		TestConfig.addLedgerUrl = ConfigFile.getUrl(InterfaceName.AddLedger);
		TestConfig.updateLedgerUrl = ConfigFile.getUrl(InterfaceName.UpdateLedger);
		TestConfig.delLedgerUrl = ConfigFile.getUrl(InterfaceName.DelLedger);
		TestConfig.getLedgerListsUrl = ConfigFile.getUrl(InterfaceName.GetLedgerLists);
		TestConfig.getTaskDesignArgsPageListUrl = ConfigFile.getUrl(InterfaceName.GetTaskDesignArgsPageList);
		TestConfig.addTaskDesignArgsUrl = ConfigFile.getUrl(InterfaceName.AddTaskDesignArgs);
		TestConfig.updateTaskDesignArgsUrl = ConfigFile.getUrl(InterfaceName.UpdateTaskDesignArgs);
		TestConfig.delTaskDesignArgsUrl = ConfigFile.getUrl(InterfaceName.DelTaskDesignArgs);
		TestConfig.getEngineeringSectionListUrl = ConfigFile.getUrl(InterfaceName.GetEngineeringSectionList);
		TestConfig.addEngineeringSectionUrl = ConfigFile.getUrl(InterfaceName.AddEngineeringSection);
		TestConfig.updateEngineeringSectionUrl = ConfigFile.getUrl(InterfaceName.UpdateEngineeringSection);
		TestConfig.delEngineeringSectionUrl = ConfigFile.getUrl(InterfaceName.DelEngineeringSection);
		TestConfig.engineeringSectionUrl = ConfigFile.getUrl(InterfaceName.EngineeringSection);
		TestConfig.getProListUrl = ConfigFile.getUrl(InterfaceName.GetProList);
		TestConfig.getImportModuleListUrl = ConfigFile.getUrl(InterfaceName.GetImportModuleList);
		TestConfig.getCommonConstantUrl = ConfigFile.getUrl(InterfaceName.GetCommonConstant);
		TestConfig.getMaterialCodeJadinecListUrl = ConfigFile.getUrl(InterfaceName.GetMaterialCodeJadinecList);
		TestConfig.getMaterialCategoryListUrl = ConfigFile.getUrl(InterfaceName.GetMaterialCategoryList);
		TestConfig.addOrUpdateMaterialCategoryUrl = ConfigFile.getUrl(InterfaceName.AddOrUpdateMaterialCategory);
		TestConfig.delMaterialCategoryUrl = ConfigFile.getUrl(InterfaceName.DelMaterialCategory);
		TestConfig.getMaterialCategoryPageListUrl = ConfigFile.getUrl(InterfaceName.GetMaterialCategoryPageList);
		TestConfig.getDrawLevelPageListUrl = ConfigFile.getUrl(InterfaceName.GetDrawLevelPageList);
		TestConfig.getDrawLevelListUrl = ConfigFile.getUrl(InterfaceName.GetDrawLevelList);
		TestConfig.addDrawLevelUrl = ConfigFile.getUrl(InterfaceName.AddDrawLevel);
		TestConfig.updateDrawLevelUrl = ConfigFile.getUrl(InterfaceName.UpdateDrawLevel);
		TestConfig.delDrawLevelUrl = ConfigFile.getUrl(InterfaceName.DelDrawLevel);
		TestConfig.getImportConfigListUrl = ConfigFile.getUrl(InterfaceName.GetImportConfigList);
		TestConfig.addImportConfigUrl = ConfigFile.getUrl(InterfaceName.AddImportConfig);
		TestConfig.updateImportConfigUrl = ConfigFile.getUrl(InterfaceName.UpdateImportConfig);
		TestConfig.delImportConfigUrl = ConfigFile.getUrl(InterfaceName.DelImportConfig);
		TestConfig.importConfigDetailUrl = ConfigFile.getUrl(InterfaceName.ImportConfigDetail);
		TestConfig.importConfigUrl = ConfigFile.getUrl(InterfaceName.ImportConfig);
		TestConfig.importTemplateUrl = ConfigFile.getUrl(InterfaceName.ImportTemplate);
		TestConfig.getExcavationMethodListUrl = ConfigFile.getUrl(InterfaceName.GetExcavationMethodList);
		TestConfig.addOrUpdateExcavationMethodUrl = ConfigFile.getUrl(InterfaceName.AddOrUpdateExcavationMethod);
		TestConfig.delExcavationMethodUrl = ConfigFile.getUrl(InterfaceName.DelExcavationMethod);
		TestConfig.exportExcavationMethodUrl = ConfigFile.getUrl(InterfaceName.ExportExcavationMethod);
		TestConfig.importExcavationMethodUrl = ConfigFile.getUrl(InterfaceName.ImportExcavationMethod);
		TestConfig.getBillCodeProcessCodeListUrl = ConfigFile.getUrl(InterfaceName.GetBillCodeProcessCodeList);
		TestConfig.addOrUpdateBillCodeToProcessCodeUrl = ConfigFile.getUrl(InterfaceName.AddOrUpdateBillCodeToProcessCode);
		TestConfig.delBillCodeProcessCodeUrl = ConfigFile.getUrl(InterfaceName.DelBillCodeProcessCode);
		TestConfig.exportBillCodeProcessCodeUrl = ConfigFile.getUrl(InterfaceName.ExportBillCodeProcessCode);
		TestConfig.importBillCodeProcessCodeUrl = ConfigFile.getUrl(InterfaceName.ImportBillCodeProcessCode);
		TestConfig.getFileHistoryListUrl = ConfigFile.getUrl(InterfaceName.GetFileHistoryList);
		TestConfig.getEngineeringCategoryListUrl = ConfigFile.getUrl(InterfaceName.GetEngineeringCategoryList);
		TestConfig.updateEngineeringCategoryUrl = ConfigFile.getUrl(InterfaceName.UpdateEngineeringCategory);
		TestConfig.engineeringCategoryDetailUrl = ConfigFile.getUrl(InterfaceName.EngineeringCategoryDetail);		                                                                                                    
		TestConfig.engineeringCategoryUrl = ConfigFile.getUrl(InterfaceName.EngineeringCategory);
		TestConfig.getEngineeringLevelListUrl = ConfigFile.getUrl(InterfaceName.GetEngineeringLevelList);
		TestConfig.updateEngineeringLevelUrl = ConfigFile.getUrl(InterfaceName.UpdateEngineeringLevel);
		TestConfig.engineeringLevelDetailUrl = ConfigFile.getUrl(InterfaceName.EngineeringLevelDetail);
		TestConfig.getEngineeringTypeListUrl = ConfigFile.getUrl(InterfaceName.GetEngineeringTypeList);
		TestConfig.addEngineeringTypeUrl = ConfigFile.getUrl(InterfaceName.AddEngineeringType);
		TestConfig.updateEngineeringTypeUrl = ConfigFile.getUrl(InterfaceName.UpdateEngineeringType);
		TestConfig.getLedgerChangeInfoPageListUrl = ConfigFile.getUrl(InterfaceName.GetLedgerChangeInfoPageList);
		TestConfig.addLedgerChangeInfoUrl = ConfigFile.getUrl(InterfaceName.AddLedgerChangeInfo);
		TestConfig.updateLedgerChangeInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateLedgerChangeInfo);
		TestConfig.delLedgerChangeInfoUrl = ConfigFile.getUrl(InterfaceName.DelLedgerChangeInfo);
		TestConfig.getLedgerChangeInfoUrl = ConfigFile.getUrl(InterfaceName.GetLedgerChangeInfo);
		TestConfig.getLedgerChangeDetailPageListUrl = ConfigFile.getUrl(InterfaceName.GetLedgerChangeDetailPageList);
		TestConfig.getLedgerChangeAmountSumUrl = ConfigFile.getUrl(InterfaceName.GetLedgerChangeAmountSum);
		TestConfig.getLedgerPageListsUrl = ConfigFile.getUrl(InterfaceName.GetLedgerPageLists);
		TestConfig.getLedgerChangeListUrl = ConfigFile.getUrl(InterfaceName.GetLedgerChangeList);
		TestConfig.addLedgerChangeUrl = ConfigFile.getUrl(InterfaceName.AddLedgerChange);
		TestConfig.updateLedgerChangeUrl = ConfigFile.getUrl(InterfaceName.UpdateLedgerChange);
		TestConfig.delLedgerChangeUrl = ConfigFile.getUrl(InterfaceName.DelLedgerChange);
		TestConfig.getBillChangePageListUrl = ConfigFile.getUrl(InterfaceName.GetBillChangePageList);
		TestConfig.addBillChangeUrl = ConfigFile.getUrl(InterfaceName.AddBillChange);
		TestConfig.updateBillChangeUrl = ConfigFile.getUrl(InterfaceName.UpdateBillChange);
		TestConfig.delBillChangeUrl = ConfigFile.getUrl(InterfaceName.DelBillChange);
		TestConfig.delEngineeringTypeUrl = ConfigFile.getUrl(InterfaceName.DelEngineeringType);
		TestConfig.engineeringTypeUrl = ConfigFile.getUrl(InterfaceName.EngineeringType);
		TestConfig.engineeringTypeDetailUrl = ConfigFile.getUrl(InterfaceName.EngineeringTypeDetail);
		TestConfig.importEngineeringTypeUrl = ConfigFile.getUrl(InterfaceName.ImportEngineeringType);
		TestConfig.addOrUpdateMaterialCodeUrl = ConfigFile.getUrl(InterfaceName.AddOrUpdateMaterialCode);
		TestConfig.delMaterialCodeByIdsUrl = ConfigFile.getUrl(InterfaceName.DelMaterialCodeByIds);
		TestConfig.getMaterialCodeByIdUrl = ConfigFile.getUrl(InterfaceName.GetMaterialCodeById);
		TestConfig.getMixtureUrl = ConfigFile.getUrl(InterfaceName.GetMixture);
		TestConfig.importMaterialCodeUrl = ConfigFile.getUrl(InterfaceName.ImportMaterialCode);
		TestConfig.exportMaterialCodeUrl = ConfigFile.getUrl(InterfaceName.ExportMaterialCode);
		TestConfig.addOrUpdateMechanicalTypeUrl = ConfigFile.getUrl(InterfaceName.AddOrUpdateMechanicalType);
		TestConfig.delMechanicalByIdUrl = ConfigFile.getUrl(InterfaceName.DelMechanicalById);
		TestConfig.importMechanicalUrl = ConfigFile.getUrl(InterfaceName.ImportMechanical);
		TestConfig.exportMechanicalUrl = ConfigFile.getUrl(InterfaceName.ExportMechanical);
		TestConfig.baseImportUrl = ConfigFile.getUrl(InterfaceName.BaseImport);
		TestConfig.baseExportsUrl = ConfigFile.getUrl(InterfaceName.BaseExports);
		TestConfig.baseGetPageListUrl = ConfigFile.getUrl(InterfaceName.BaseGetPageList);
		TestConfig.baseDeleteByIdUrl = ConfigFile.getUrl(InterfaceName.BaseDeleteById);
		TestConfig.baseGetByIdUrl = ConfigFile.getUrl(InterfaceName.BaseGetById);
		TestConfig.addOrUpdateRoadLineUrl = ConfigFile.getUrl(InterfaceName.AddOrUpdateRoadLine);
		TestConfig.findTemplateListUrl = ConfigFile.getUrl(InterfaceName.FindTemplateList);
		TestConfig.getWorkBulletinListUrl = ConfigFile.getUrl(InterfaceName.GetWorkBulletinList);
		TestConfig.getFinishEngineeringListUrl = ConfigFile.getUrl(InterfaceName.GetFinishEngineeringList);
		TestConfig.getWorkingEngineeringListUrl = ConfigFile.getUrl(InterfaceName.GetWorkingEngineeringList);
		TestConfig.exportUrl = ConfigFile.getUrl(InterfaceName.Export);
		TestConfig.getReportRegularDetailUrl = ConfigFile.getUrl(InterfaceName.GetReportRegularDetail);
		TestConfig.listUrl = ConfigFile.getUrl(InterfaceName.List);
		TestConfig.tokenUrl = ConfigFile.getUrl(InterfaceName.Token);
		TestConfig.getAllOrgNamesUrl = ConfigFile.getUrl(InterfaceName.GetAllOrgNames);
		TestConfig.addOrgInfoUrl = ConfigFile.getUrl(InterfaceName.AddOrgInfo);
		TestConfig.updateOssOrgInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateOssOrgInfo);
		TestConfig.getOrgInfoByOrgIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgInfoByOrgId);
		TestConfig.delOrgInfoByOrgIdUrl = ConfigFile.getUrl(InterfaceName.DelOrgInfoByOrgId);
		TestConfig.getOrgListByPageUrl = ConfigFile.getUrl(InterfaceName.GetOrgListByPage);
		TestConfig.updateOssOrgBaseInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateOssOrgBaseInfo);
		TestConfig.getEntireOrgTreeByOrgIdUrl = ConfigFile.getUrl(InterfaceName.GetEntireOrgTreeByOrgId);
		TestConfig.getAllOrgWithoutDefaultUrl = ConfigFile.getUrl(InterfaceName.GetAllOrgWithoutDefault);
		TestConfig.getParentOrgByOrgCategoryUrl = ConfigFile.getUrl(InterfaceName.GetParentOrgByOrgCategory);
		TestConfig.getOrgProInfoByProIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgProInfoByProId);
		TestConfig.addOrgProInfoUrl = ConfigFile.getUrl(InterfaceName.AddOrgProInfo);
		TestConfig.updateOssOrgProInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateOssOrgProInfo);
		TestConfig.delOrgProInfoByProIdUrl = ConfigFile.getUrl(InterfaceName.DelOrgProInfoByProId);
		TestConfig.getOrgProListByPageUrl = ConfigFile.getUrl(InterfaceName.GetOrgProListByPage);
		TestConfig.getEntireOrgProTreeByProIdUrl = ConfigFile.getUrl(InterfaceName.GetEntireOrgProTreeByProId);
		TestConfig.getProsByOrgIdsUrl = ConfigFile.getUrl(InterfaceName.GetProsByOrgIds);
		TestConfig.getSpecifyProOutputValueUrl = ConfigFile.getUrl(InterfaceName.GetSpecifyProOutputValue);
		TestConfig.addOssOrgDeptInfoUrl = ConfigFile.getUrl(InterfaceName.AddOssOrgDeptInfo);
		TestConfig.updateOssDeptInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateOssDeptInfo);
		TestConfig.getOrgDeptInfoByDeptIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgDeptInfoByDeptId);
		TestConfig.delOrgDeptInfoByDeptIdUrl = ConfigFile.getUrl(InterfaceName.DelOrgDeptInfoByDeptId);
		TestConfig.addOrgDeptInfoUrl = ConfigFile.getUrl(InterfaceName.AddOrgDeptInfo);
		TestConfig.updateDeptInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateDeptInfo);
		TestConfig.getEntireOrgDeptTreeByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetEntireOrgDeptTreeByUserId);
		TestConfig.getOrgDeptsByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgDeptsByUserId);
		TestConfig.getProDeptsByProIdUrl = ConfigFile.getUrl(InterfaceName.GetProDeptsByProId);
		TestConfig.getOrgUsersWithoutWorkerByDeptIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgUsersWithoutWorkerByDeptId);
		TestConfig.getOrgDeptWithoutProDeptsByOrgIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgDeptWithoutProDeptsByOrgId);
		TestConfig.getEntireProDeptTreeByProIdUrl = ConfigFile.getUrl(InterfaceName.GetEntireProDeptTreeByProId);
		TestConfig.getProUsersByProDeptIdUrl = ConfigFile.getUrl(InterfaceName.GetProUsersByProDeptId);
		TestConfig.getDeptTypeByDeptIdUrl = ConfigFile.getUrl(InterfaceName.GetDeptTypeByDeptId);
		TestConfig.addOrgJobInfoUrl = ConfigFile.getUrl(InterfaceName.AddOrgJobInfo);
		TestConfig.updateOrgJobUrl = ConfigFile.getUrl(InterfaceName.UpdateOrgJob);
		TestConfig.getOrgJobInfoByJobIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgJobInfoByJobId);
		TestConfig.delOrgJobInfoByJobIdUrl = ConfigFile.getUrl(InterfaceName.DelOrgJobInfoByJobId);
		TestConfig.getOrgJobInfoListByPageUrl = ConfigFile.getUrl(InterfaceName.GetOrgJobInfoListByPage);
		TestConfig.getProJobInfoListByPageUrl = ConfigFile.getUrl(InterfaceName.GetProJobInfoListByPage);
		TestConfig.getOrgJobInfosByOrgDeptIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgJobInfosByOrgDeptId);
		TestConfig.addOrgRoleInfoUrl = ConfigFile.getUrl(InterfaceName.AddOrgRoleInfo);
		TestConfig.getOrgRoleInfoByRoleIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgRoleInfoByRoleId);
		TestConfig.updateOrgRoleInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateOrgRoleInfo);
		TestConfig.delOrgRoleInfoByRoleIdUrl = ConfigFile.getUrl(InterfaceName.DelOrgRoleInfoByRoleId);
		TestConfig.getOrgRoleInfoListByPageUrl = ConfigFile.getUrl(InterfaceName.GetOrgRoleInfoListByPage);
		TestConfig.getProRoleInfoListByPageUrl = ConfigFile.getUrl(InterfaceName.GetProRoleInfoListByPage);
		TestConfig.updateOrgRole2ResUrl = ConfigFile.getUrl(InterfaceName.UpdateOrgRole2Res);
		TestConfig.getOrgRolesByOrgIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgRolesByOrgId);
		TestConfig.getProRolesByProIdUrl = ConfigFile.getUrl(InterfaceName.GetProRolesByProId);
		TestConfig.getOrgResByRoleIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgResByRoleId);
		TestConfig.getUserAllInfoByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetUserAllInfoByUserId);
		TestConfig.getUserBaseInfoByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetUserBaseInfoByUserId);
		TestConfig.getOrgUserCertificatesByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgUserCertificatesByUserId);
		TestConfig.getOrgUserProExperiencesByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgUserProExperiencesByUserId);
		TestConfig.getOrgUserWorkExperiencesByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgUserWorkExperiencesByUserId);
		TestConfig.updateOrgUserBaseInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateOrgUserBaseInfo);
		TestConfig.getMyOssResListUrl = ConfigFile.getUrl(InterfaceName.GetMyOssResList);
		TestConfig.getMyOrgResListUrl = ConfigFile.getUrl(InterfaceName.GetMyOrgResList);
		TestConfig.getMyProResListUrl = ConfigFile.getUrl(InterfaceName.GetMyProResList);
		TestConfig.getProUserListByPageUrl = ConfigFile.getUrl(InterfaceName.GetProUserListByPage);
		TestConfig.getOrgUserListByPageUrl = ConfigFile.getUrl(InterfaceName.GetOrgUserListByPage);
		TestConfig.delUserInfoUrl = ConfigFile.getUrl(InterfaceName.DelUserInfo);
		TestConfig.disableUserLoginUrl = ConfigFile.getUrl(InterfaceName.DisableUserLogin);
		TestConfig.enableUserLoginUrl = ConfigFile.getUrl(InterfaceName.EnableUserLogin);
		TestConfig.updateUserLoginPasswordUrl = ConfigFile.getUrl(InterfaceName.UpdateUserLoginPassword);
		TestConfig.updateCompanyUserInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateCompanyUserInfo);
		TestConfig.updateOssUserInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateOssUserInfo);
		TestConfig.getCompanyUserAuthorizationByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetCompanyUserAuthorizationByUserId);
		TestConfig.getOssUserAuthorizationByUserIdUrl = ConfigFile.getUrl(InterfaceName.GetOssUserAuthorizationByUserId);
		TestConfig.getOrgAdminPageListByOrgIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgAdminPageListByOrgId);
		TestConfig.getProAdminPageListByProIdUrl = ConfigFile.getUrl(InterfaceName.GetProAdminPageListByProId);
		TestConfig.addAdminUrl = ConfigFile.getUrl(InterfaceName.AddAdmin);
		TestConfig.updateAdminUrl = ConfigFile.getUrl(InterfaceName.UpdateAdmin);
		TestConfig.delAdminUrl = ConfigFile.getUrl(InterfaceName.DelAdmin);
		TestConfig.updateAdminResUrl = ConfigFile.getUrl(InterfaceName.UpdateAdminRes);
		TestConfig.sendVerifyCodeUrl = ConfigFile.getUrl(InterfaceName.SendVerifyCode);
		TestConfig.updatePwdBySmsUrl = ConfigFile.getUrl(InterfaceName.UpdatePwdBySms);
		TestConfig.updatePhoneBySmsUrl = ConfigFile.getUrl(InterfaceName.UpdatePhoneBySms);
		TestConfig.exportOrgUserUrl = ConfigFile.getUrl(InterfaceName.ExportOrgUser);
		TestConfig.findProInfoListByUserIdUrl = ConfigFile.getUrl(InterfaceName.FindProInfoListByUserId);
		TestConfig.findOrgInfoListByUserIdUrl = ConfigFile.getUrl(InterfaceName.FindOrgInfoListByUserId);
		TestConfig.findOrgInfoByUserIdUrl = ConfigFile.getUrl(InterfaceName.FindOrgInfoByUserId);
		TestConfig.getAppResListUrl = ConfigFile.getUrl(InterfaceName.GetAppResList);
		TestConfig.findProUserByProIdUrl = ConfigFile.getUrl(InterfaceName.FindProUserByProId);
		TestConfig.findLoginInfoByUserIdUrl = ConfigFile.getUrl(InterfaceName.FindLoginInfoByUserId);
		TestConfig.findOrgUserByOrgIdUrl = ConfigFile.getUrl(InterfaceName.FindOrgUserByOrgId);
		TestConfig.getUserOrgAndProListUrl = ConfigFile.getUrl(InterfaceName.GetUserOrgAndProList);
		TestConfig.getMyResListBySysIdUrl = ConfigFile.getUrl(InterfaceName.GetMyResListBySysId);
		TestConfig.getOrgResInfoByResIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgResInfoByResId);
		TestConfig.addResInfoUrl = ConfigFile.getUrl(InterfaceName.AddResInfo);
		TestConfig.updateOrgResInfoUrl = ConfigFile.getUrl(InterfaceName.UpdateOrgResInfo);
		TestConfig.delOrgResInfoByResIdUrl = ConfigFile.getUrl(InterfaceName.DelOrgResInfoByResId);
		TestConfig.getOrgResInfoListBySysIdUrl = ConfigFile.getUrl(InterfaceName.GetOrgResInfoListBySysId);
		TestConfig.getOrgResInfoListByPageUrl = ConfigFile.getUrl(InterfaceName.GetOrgResInfoListByPage);
		TestConfig.getSystemApiUrl = ConfigFile.getUrl(InterfaceName.GetSystemApi);
		TestConfig.enableOrgResUrl = ConfigFile.getUrl(InterfaceName.EnableOrgRes);
		TestConfig.getDefaultAdminOrgResUrl = ConfigFile.getUrl(InterfaceName.GetDefaultAdminOrgRes);
		TestConfig.findBandsStatMenuUrl = ConfigFile.getUrl(InterfaceName.FindBandsStatMenu);
		TestConfig.findUserMenuUrl = ConfigFile.getUrl(InterfaceName.FindUserMenu);
		TestConfig.findContractorListUrl = ConfigFile.getUrl(InterfaceName.FindContractorList);
		TestConfig.findContractorDetailsUrl = ConfigFile.getUrl(InterfaceName.FindContractorDetails);
		TestConfig.getEnumListUrl = ConfigFile.getUrl(InterfaceName.GetEnumList);
		TestConfig.getProsByOrgIdUrl = ConfigFile.getUrl(InterfaceName.GetProsByOrgId);
		TestConfig.getOrgJobDicListByPageUrl = ConfigFile.getUrl(InterfaceName.GetOrgJobDicListByPage);
		TestConfig.addOrgJobDicUrl = ConfigFile.getUrl(InterfaceName.AddOrgJobDic);
		TestConfig.updateOrgJobDicUrl = ConfigFile.getUrl(InterfaceName.UpdateOrgJobDic);
		TestConfig.getOrgJobDicListUrl = ConfigFile.getUrl(InterfaceName.GetOrgJobDicList);
		TestConfig.delOrgJobDicByIdUrl = ConfigFile.getUrl(InterfaceName.DelOrgJobDicById);
		TestConfig.exportProUserUrl = ConfigFile.getUrl(InterfaceName.ExportProUser);
		TestConfig.addOssUserBaseInfoUrl = ConfigFile.getUrl(InterfaceName.AddOssUserBaseInfo);
		TestConfig.addCompanyUserInfoUrl = ConfigFile.getUrl(InterfaceName.AddCompanyUserInfo);
		TestConfig.listsUrl = ConfigFile.getUrl(InterfaceName.Lists);
		TestConfig.addsUrl = ConfigFile.getUrl(InterfaceName.Adds);
		TestConfig.updatesUrl = ConfigFile.getUrl(InterfaceName.Updates);
		TestConfig.delsUrl = ConfigFile.getUrl(InterfaceName.Dels);
		TestConfig.getMaterialRecordListUrl = ConfigFile.getUrl(InterfaceName.GetMaterialRecordList);
