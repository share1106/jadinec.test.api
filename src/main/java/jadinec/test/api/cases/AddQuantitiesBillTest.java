...
public class AddQuantitiesBillTest {

	// 增加
	@Test
	public void addQuantitiesBillTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.addQuantitiesBillUrl);
		System.out.println(TestConfig.addQuantitiesBillUrl);
