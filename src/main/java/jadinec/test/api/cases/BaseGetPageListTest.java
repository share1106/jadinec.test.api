...
public class BaseGetPageListTest {

	public static String stringId = null;

	// 通用分页查询
	@Test
	public void baseGetPageListTest() throws IOException {
		...
		for (int k = 0; k < ja.size(); k++) {
			...
			if (jsonObj.get("roadLineName").toString().contains("G312主线")) {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.baseGetPageListUrl);
		System.out.println(TestConfig.baseGetPageListUrl);
