...
public class GetConcreteApplyListTest {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.getConcreteApplyListUrl);
		System.out.println(TestConfig.getConcreteApplyListUrl);
		JSONObject param1 = new JSONObject();
		JSONObject param2 = new JSONObject();

		param2.put("state", 1);
		param2.put("workBeginDate", "2019-05-25");
		param2.put("mixingStationId", 20);
