...
public class ImportExcavationMethodTest {

	// 隧道开挖方法导入

	@Test
	public void importExcavationMethodTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		...
		String result = "";
		String filePath = "src/main/resources/隧道开挖方法表.xlsx";

		if (StringUtils.isNotBlank(TestConfig.importExcavationMethodUrl)) {
