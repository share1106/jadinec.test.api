...
public class UpdateOssOrgBaseInfoTest {

	// 修改运营平台组织机构基本信息
	@Test
	public void updateOssOrgBaseInfoTest() throws IOException {
	...
	private JSONArray getJsonResult() throws ClientProtocolException, IOException {
		HttpPost post = new HttpPost(TestConfig.updateOssOrgBaseInfoUrl);
		System.out.println(TestConfig.updateOssOrgBaseInfoUrl);
